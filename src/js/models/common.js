...
Common.prototype.readMarkups = function readMarkups(element) {
...
Common.prototype.findPositionInElement = function findPositionInElement(positionOf, inElement) {
  ...
  const end = start + positionOf.textContent.length;
  return { start, end };
};
