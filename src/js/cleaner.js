  ...
  this.it = (element) => {
    const s = new Sanitize({
      ...
      transformers: [
        function (input) {
          ...
          } if (input.node_name === 'a' && kls.contains('item-mixtapeEmbed')) {
            return {
          ...
          } if (input.node_name === 'div' && kls.contains('iframeContainer') && prntKls.contains('item-iframe')) {
            return {
              whitelist_nodes: [input.node],
            };
          } if (input.node_name === 'iframe' && prntKls.contains('iframeContainer')) {
            return {
              whitelist_nodes: [input.node],
            };
          } if (input.node_name === 'figcaption' && prntKls.contains('item-iframe')) {
            return {
              whitelist_nodes: [input.node],
            };
          } if (input.node_name === 'div' && kls.contains('item-controls') && input.node.closest('.item-figure') != null) {
            return {
              whitelist_nodes: [input.node],
            };
          }
          ...
          } if (input.node_name === 'div' && (kls.contains('padding-cont') && prntKls.contains('item-figure'))) {
            return {
              whitelist_nodes: [input.node],
            };
          } if (input.node_name === 'div' && (kls.contains('padding-box') && prntKls.contains('padding-cont'))) {
            return {
              whitelist_nodes: [input.node],
            };
          } if (input.node_name === 'img' && input.node.closest('.item-figure') != null) {
            return {
              whitelist_nodes: [input.node],
            };
          } if (input.node_name === 'a' && prntKls.contains('item-mixtapeEmbed')) {
            return {
              attr_whitelist: ['style'],
            };
          } if (input.node_name === 'figcaption' && prntKls.contains('item-figure')) {
            return {
              whitelist_nodes: [input.node],
            };
          } if (input.node_name === 'figcaption' && prntKls.contains('block-grid')) {
            return {
              whitelist_nodes: [input.node],
            };
          } if (input.node_name === 'span' && prntKls.contains('figure-caption')) {
            return {
              whitelist_nodes: [input.node],
            };
          } if (input.node_name === 'span' && prntKls.contains('block-grid-caption')) {
            return {
              whitelist_nodes: [input.node],
            };
          }
    ...
    if (element.length) {
      for (let i = 0; i < element.length; i += 1) {
        const el = element[i];
        const cleanNode = s.clean_node(el);
        el.innerHTML = '';
